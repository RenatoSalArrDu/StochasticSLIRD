...
fig.text(0.51, 0.01, r'$\mathrm{days}$', ha='center',fontsize=(25))
fig.text(0.01, 0.51, r'$\mathrm{individuals}$', va='center', rotation='vertical',fontsize=(25))
...
###############################################################################
ax1.plot(p1[:,0],p1[:,1] ,color = colormap3(normalize3(1)), label=r'$L(t)$', linewidth=1.5)
ax1.plot(p1[:,0],p1[:,3] ,color = colormap3(normalize3(2)), label=r'$I(t)$', linewidth=1.5)
ax1.plot(p1[:,0],p1[:,4] ,color = colormap3(normalize3(3)), label=r'$R(t)$', linewidth=1.5)
ax1.plot(p1[:,0],p1[:,5] ,color = colormap3(normalize3(4)), label=r'$D(t)$', linewidth=1.5)
ax1.plot(p1[:,0],p1[:,6] ,color = colormap3(normalize3(5)), label=r'$c(t)$', linewidth=1.5)
...
ax2.bar(p2[:,0],p2[:,2],color = colormap2(normalize2(3)),label=r'$i(t)$', width=0.9)
...
axw2.bar(0,0,color = colormap2(normalize2(3)),label=r'$i(t)$', width=0.9)
...
left, bottom, width, height = [0.322, 0.3, 0.15, 0.19]
ax2s = fig.add_axes([left, bottom, width, height])
ax2s.bar(p2[:,0],p2[:,2],color = colormap2(normalize2(3)), width=0.9)
...
ax3.bar(p500K1[:,0],p500K1[:,1]/500000,color = colormap(normalize(1)), label=r'$500K$', width=0.9)
ax3.bar(p1M1[:,0],p1M1[:,1]/1000000,color = colormap(normalize(2)),label=r'$1M$', width=0.8)
ax3.bar(p5M1[:,0],p5M1[:,1]/5000000,color = colormap(normalize(3)), label=r'$5M$', width=0.7)
ax3.bar(p10M1[:,0],p10M1[:,1]/10000000,color = colormap(normalize(4)), label=r'$10M$', width=0.6)
