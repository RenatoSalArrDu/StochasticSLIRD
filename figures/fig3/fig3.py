...
fig.text(0.01, 0.51, r'$\mathrm{individuals}$', va='center', rotation='vertical',fontsize=(20))
plt.subplots_adjust(left=0.1, right=0.95,top=0.95, bottom=0.13)

################################################################################

ax4.bar(d30a1[:,0],d30a1[:,2],color = colormap2(normalize2(3)), width=0.9)
...
ax4.grid(False)
ax4w = ax4.twinx()
ax4w.plot(d30a2[:,0],d30a2[:,1],color = colormap(normalize(2)),label=r'$W(t)$', linewidth=2)
ax4w.plot(d30a2[:,0],d30a2[:,2],color = colormap(normalize(4)),label=r'$C(t)$', linewidth=1.5)
ax4w.plot(d30a2[:,0],d30a2[:,3],color = colormap(normalize(6)),label=r'$H(t)$', linewidth=1.5)
ax4w.bar(0,0,color = colormap2(normalize2(3)),label=r'$i(t)$', width=0.9)
ax4w.tick_params(axis='y', labelcolor=colorr)
ax4w.tick_params(labelsize='13',labeltop=False, labelright=False, labelbottom=False)
ax4w.legend(borderpad=0.3, shadow = True, loc='lower right', ncol=1,fontsize=(13))
ax4w.set_xlim(right = 200 , left = 0)
ax4w.text(180, 0.86, "a)",fontsize=(20))
ax4w.grid(True)


ax5.bar(d30b1[:,0],d30b1[:,2],color = colormap2(normalize2(3)), width=0.9)
...
ax5.grid(False)
ax5w = ax5.twinx()
ax5w.plot(d30b2[:,0],d30b2[:,1],color = colormap(normalize(2)),label=r'$W(t)$', linewidth=1.8)
ax5w.plot(d30b2[:,0],d30b2[:,2],color = colormap(normalize(4)),label=r'$C(t)$', linewidth=1.5)
ax5w.plot(d30b2[:,0],d30b2[:,3],color = colormap(normalize(6)),label=r'$H(t)$', linewidth=1.5)
ax5w.bar(0,0,color = colormap(normalize(3)),label=r'$i(t)$', width=0.9)
ax5w.tick_params(axis='y', labelcolor=colorr)
...
ax5w.text(450, 0.86, "b)",fontsize=(20))
ax5w.grid(True)


ax6.bar(d30c1[:,0],d30c1[:,2],color = colormap2(normalize2(3)), width=0.9)
...
ax6.grid(False)
ax6w = ax6.twinx()
ax6w.plot(d30c2[:,0],d30c2[:,1],color = colormap(normalize(2)),label=r'W(t)', linewidth=1.8)
ax6w.plot(d30c2[:,0],d30c2[:,2],color = colormap(normalize(4)),label=r'C(t)', linewidth=1.5)
ax6w.plot(d30c2[:,0],d30c2[:,3],color = colormap(normalize(6)),label=r'H(t)', linewidth=1.5)
ax6w.bar(0,0,color = colormap(normalize(3)),label=r'$i(t)$', width=0.9)
ax6w.tick_params(axis='y', labelcolor=colorr)
...
ax6w.text(450, 0.86, "c)",fontsize=(20))
ax6w.grid(True)
...
ax7.bar(d60a1[:,0],d60a1[:,2],color = colormap2(normalize2(3)), width=0.9)
...
ax7.grid(False)
ax7w = ax7.twinx()
ax7w.plot(d60a2[:,0],d60a2[:,1],color = colormap(normalize(2)),label=r'$W(t)$', linewidth=1.8)
ax7w.plot(d60a2[:,0],d60a2[:,2],color = colormap(normalize(4)),label=r'$C(t)$', linewidth=1.5)
ax7w.plot(d60a2[:,0],d60a2[:,3],color = colormap(normalize(6)),label=r'$H(t)$', linewidth=1.5)
ax7w.bar(0,0,color = colormap(normalize(3)),label=r'$i(t)$', width=0.9)
ax7w.tick_params(axis='y', labelcolor=colorr)
...
ax7w.text(180, 0.86, "d)",fontsize=(20))
ax7w.grid(True)


ax8.bar(d60b1[:,0],d60b1[:,2],color = colormap2(normalize2(3)), width=0.9)
...
ax8.grid(False)
ax8w = ax8.twinx()
ax8w.plot(d60b2[:,0],d60b2[:,1],color = colormap(normalize(2)),label=r'$W(t)$', linewidth=1.8)
ax8w.plot(d60b2[:,0],d60b2[:,2],color = colormap(normalize(4)),label=r'$C(t)$', linewidth=1.5)
ax8w.plot(d60b2[:,0],d60b2[:,3],color = colormap(normalize(6)),label=r'$H(t)$', linewidth=1.5)
ax8w.bar(0,0,color = colormap(normalize(3)),label=r'$i(t)$', width=0.9)
ax8w.tick_params(axis='y', labelcolor=colorr)
...
ax8w.text(450, 0.86, "e)",fontsize=(20))
ax8w.grid(True)


ax9.bar(d60c1[:,0],d60c1[:,2],color = colormap2(normalize2(3)), width=0.9)
...
ax9.grid(False)
ax9w = ax9.twinx()
ax9w.plot(d60c2[:,0],d60c2[:,1],color = colormap(normalize(2)),label=r'$W(t)$', linewidth=1.8)
ax9w.plot(d60c2[:,0],d60c2[:,2],color = colormap(normalize(4)),label=r'$C(t)$', linewidth=1.5)
ax9w.plot(d60c2[:,0],d60c2[:,3],color = colormap(normalize(6)),label=r'$H(t)$', linewidth=1.5)
ax9w.bar(0,0,color = colormap(normalize(3)),label=r'$i(t)$', width=0.9)
ax9w.tick_params(axis='y', labelcolor=colorr)
...
ax9w.text(450, 0.86, "f)",fontsize=(20))
ax9w.grid(True)
...
ax10.bar(d60i90d120a1[:,0],d60i90d120a1[:,2],color = colormap2(normalize2(3)), width=0.9)
...
ax10.grid(False)
ax10w = ax10.twinx()
ax10w.plot(d60i90d120a2[:,0],d60i90d120a2[:,1],color = colormap(normalize(2)),label=r'$W(t)$', linewidth=1.8)
ax10w.plot(d60i90d120a2[:,0],d60i90d120a2[:,2],color = colormap(normalize(4)),label=r'$C(t)$', linewidth=1.5)
ax10w.plot(d60i90d120a2[:,0],d60i90d120a2[:,3],color = colormap(normalize(6)),label=r'$H(t)$', linewidth=1.5)
ax10w.bar(0,0,color = colormap(normalize(3)),label=r'$i(t)$', width=0.9)
ax10w.tick_params(axis='y', labelcolor=colorr)
...
ax10w.text(180, 0.86, "g)",fontsize=(20))
ax10w.grid(True)


ax11.bar(d60i90d120b1[:,0],d60i90d120b1[:,2],color = colormap2(normalize2(3)), width=0.9)
...
ax11.grid(False)
ax11w = ax11.twinx()
ax11w.plot(d60i90d120b2[:,0],d60i90d120b2[:,1],color = colormap(normalize(2)),label=r'$W(t)$', linewidth=1.8)
ax11w.plot(d60i90d120b2[:,0],d60i90d120b2[:,2],color = colormap(normalize(4)),label=r'$C(t)$', linewidth=1.5)
ax11w.plot(d60i90d120b2[:,0],d60i90d120b2[:,3],color = colormap(normalize(6)),label=r'$H(t)$', linewidth=1.5)
ax11w.bar(0,0,color = colormap(normalize(3)),label=r'$i(t)$', width=0.9)
ax11w.tick_params(axis='y', labelcolor=colorr)
...
ax11w.text(450, 0.86, "h)",fontsize=(20))
ax11w.grid(True)


ax12.bar(d60i90d120c1[:,0],d60i90d120c1[:,2],color = colormap2(normalize2(3)), width=0.9)
...
ax12.grid(False)
ax12w = ax12.twinx()
ax12w.plot(d60i90d120c2[:,0],d60i90d120c2[:,1],color = colormap(normalize(2)),label=r'$W(t)$', linewidth=1.8)
ax12w.plot(d60i90d120c2[:,0],d60i90d120c2[:,2],color = colormap(normalize(4)),label=r'$C(t)$', linewidth=1.5)
ax12w.plot(d60i90d120c2[:,0],d60i90d120c2[:,3],color = colormap(normalize(6)),label=r'$H(t)$', linewidth=1.5)
ax12w.bar(0,0,color = colormap(normalize(3)),label=r'$i(t)$', width=0.9)
ax12w.tick_params(axis='y', labelcolor=colorr)
...
ax12w.text(450, 0.86, "i)",fontsize=(20))
ax12w.grid(True)
