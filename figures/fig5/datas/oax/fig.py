...
dato=np.loadtxt('/home/pclopez/scham/epidemia/StochasticSLIRD//code/Mexico_covid-19_datas/datas20_08_21/oax.dat')
ntotst=len(dato[:,0])
...
plt.bar(dato[:,0],dato[:,1],color = colormap(normalize(3)),label='oax', width=0.7)
...
plt.tight_layout()
figure_name = 'figoax.eps'	# name of the figure to be saved
