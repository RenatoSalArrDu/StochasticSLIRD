...
ax1.set_xlim(left = -0.005, right = 0.5)
...
ax2.set_xlim(left = -0.005, right = 0.5)
...
ax3.set_xlim(left = -0.005, right = 0.5)
...
ax4.set_xlim(left = -0.005, right = 0.5)
...
ax5.set_xlim(left = -0.005, right = 0.5)
...
ax6.set_xlim(left = -0.005, right = 0.5)
...
ax7.set_xlim(left = -0.005, right = 0.5)
...
ax8.set_xlim(left = -0.005, right = 0.5)
...
ax9.set_xlim(left = -0.005, right = 0.5)
