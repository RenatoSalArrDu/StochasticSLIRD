...
plt.subplot(223)
plt.plot(dat[:,0],dat[:,6],color = colormap(normalize(3)),label='cummulant', linewidth=2)
plt.tick_params(labelsize='30',labeltop=False, labelright=False, labelbottom=True)
plt.legend(borderpad=0.1, shadow = True, loc='best', ncol=1,fontsize=(25))
plt.yscale('log')
plt.grid(True)


plt.subplot(224)
plt.plot(dat3[:,0],dat3[:,1],color = colormap(normalize(1)),label=r'W(t)', linewidth=2)
plt.plot(dat3[:,0],dat3[:,2],color = colormap(normalize(3)),label=r'C(t)', linewidth=2)
plt.plot(dat3[:,0],dat3[:,3],color = colormap(normalize(5)),label=r'H(t)', linewidth=2)
plt.tick_params(labelsize='30',labeltop=False, labelright=False, labelbottom=True)
