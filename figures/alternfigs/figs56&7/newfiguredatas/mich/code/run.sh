...
wpr2=0.45 # value of the 1st decrement (increment)
...
runs=/Users/supercarlangas/schamm/epidemiology/Random_SLIRD/manuscript/figures/fits/newfiguredatas/mich/
code=/Users/supercarlangas/schamm/epidemiology/Random_SLIRD/manuscript/figures/fits/newfiguredatas/mich/code
#========================================================================================================
#=========================================================================================================
if [ $cop == '4' ]; then
