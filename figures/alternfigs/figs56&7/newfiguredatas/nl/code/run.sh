...
#$ -S /bin/bash
# ============= Parameters =================!
# ==== > These parameters come from the user < ====!
# ==== > Initial population distro.

ni=4 #3 #7      # initial infected
ns=9999996 #3   # initial susceptible
...
#reference
#ags, bc, bcs, camp, cdmx, chih, chps, coah, coli,dur, gto, guerr, hid, jal
...
#cdmx=34-$t_l, jal=55-$t_l, nl=52-$t_l
tshf=22 #67 #51 #66 #64
...
tph3=30    # day of 1st decrement (increment)
tdays=3    # duration of 1st decrement (increment)
wpr2=0.325  #0.40 #0.45  # value of the 1st decrement (increment)

tph4=85    # day of 2nd decrement (increment)
tdays2=30   # duration of 2nd decrement (increment)
wpr3=0.35 #0.38 #0.42 #0.57 #0.55  # value of the 2nd decrement (increment)

tph5=135    # day of 3rd decrement (increment)
tdays3=1   # duration of 3rd decrement (increment)
wpr4=0.1  # value of the 3rd decrement (increment)

tph6=145   # day of 4th decrement (increment)
tdays4=3   # duration of 4th decrement (increment)
wpr5=0.25  # value of the 4th decrement (increment)

tph7=183   # day of 5th decrement (increment)
tdays5=3   # duration of 5th decrement (increment)
wpr6=0.28 #0.27  #0.35  # value of the 5th decrement (increment)

tph8=248  #317   # day of 6th decrement (increment)
tdays6=3 #5   # duration of 6th decrement (increment)
wpr7=0.26 #0.28 #0.27  # value of the 6th decrement (increment) *****here

tph9=300 #327   # day of 7th decrement (increment)
tdays7=1 #7   # duration of 7th decrement (increment)
wpr8=0.38 #0.37 #0.35 #0.32 #0.3 #0.38   # value of the 7th decrement (increment) *** here

tph10=310 #318    # day of 8th decrement (increment)
tdays8=1   # duration of 8th decrement (increment)
wpr9=0.18 #0.2 #0.19 #0.15   # value of the 8th decrement (increment)

tph11=370 #478 #348    # day of 9th decrement (increment)
tdays9=3   # duration of 9th decrement (increment)
wpr10=0.24  # value of the 9th decrement (increment)

tph12=465 #468 #478 #348    # day of 9th decrement (increment)
tdays10=1   # duration of 9th decrement (increment)
wpr11=0.5 #0.5  # value of the 9th decrement (increment)

tph13=510 #468 #478 #348    # day of 9th decrement (increment)
tdays11=3   # duration of 9th decrement (increment)
wpr12=0.2 #0.5  # value of the 9th decrement (increment)
...
runs=/Users/supercarlangas/schamm/epidemiology/Random_SLIRD/manuscript/figures/fits/newfiguredatas/nl/
code=/Users/supercarlangas/schamm/epidemiology/Random_SLIRD/manuscript/figures/fits/newfiguredatas/nl/code
#========================================================================================================
#=========================================================================================================
if [ $cop == '4' ]; then
...
# plt.plot(dat5[:,0]+$tshf,dat5[:,1],color = colormap(normalize(1)),marker='$mark',
