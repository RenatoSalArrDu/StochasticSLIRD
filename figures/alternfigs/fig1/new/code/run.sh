...
ni=10 #3 #7      # initial infected
ns=999990 #3   # initial susceptible
...
ntot=200 #480 #402 #405    # number of time units (total number of days)
ro=4      # basic rep. num.
leth=0.1   # fatality
...
tph3=32 # day of 1st decrement (increment)
tdays=19    # duration of 1st decrement (increment)
wpr2=0.42 # value of the 1st decrement (increment)

tph4=54    # day of 2nd decrement (increment)
tdays2=40   # duration of 2nd decrement (increment)
wpr3=0.25 #0.57 #0.55  # value of the 2nd decrement (increment)

tph5=229    # day of 3rd decrement (increment)
tdays3=5   # duration of 3rd decrement (increment)
wpr4=0.3  # value of the 3rd decrement (increment)

tph6=270   # day of 4th decrement (increment)
tdays4=5   # duration of 4th decrement (increment)
wpr5=0.4 #0.27  # value of the 4th decrement (increment)

tph7=294   # day of 5th decrement (increment)
tdays5=3   # duration of 5th decrement (increment)
wpr6=0.25 #0.42  #0.35  # value of the 5th decrement (increment)
...
runs=/Users/supercarlangas/schamm/epidemiology/Random_SLIRD/manuscript/figures/heardimmfig/new/
code=/Users/supercarlangas/schamm/epidemiology/Random_SLIRD/manuscript/figures/heardimmfig/new/code
#========================================================================================================
#=========================================================================================================
if [ $cop == '4' ]; then
