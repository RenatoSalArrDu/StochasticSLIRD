...
tph3=30 #10 # day of 1st decrement (increment)
tdays=3 #7    # duration of 1st decrement (increment)
wpr2=0.5 # value of the 1st decrement (increment)
...
runs=/Users/supercarlangas/schamm/epidemiology/Random_SLIRD/manuscript/figures/fits/newfiguredatas/edmx/
code=/Users/supercarlangas/schamm/epidemiology/Random_SLIRD/manuscript/figures/fits/newfiguredatas/edmx/code
#========================================================================================================
#=========================================================================================================
if [ $cop == '4' ]; then
