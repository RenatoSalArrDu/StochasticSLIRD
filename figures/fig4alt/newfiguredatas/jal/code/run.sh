...
ni=7 #3 #7      # initial infected
ns=9999993 #3   # initial susceptible
...
ro=4      # basic rep. num.
leth=0.1   # fatality
traj=5000   #nunber of trajectories
...
state=jal
date=20_08_21 #28_04_21 #23_02_21
...
tph3=20    # day of 1st decrement (increment)
tdays=7    # duration of 1st decrement (increment)
wpr2=0.35 #0.40 #0.45  # value of the 1st decrement (increment)

tph4=74    # day of 2nd decrement (increment)
tdays2=3   # duration of 2nd decrement (increment)
wpr3=0.61 #0.6 #0.62 #0.57 #0.55  # value of the 2nd decrement (increment)

tph5=120 #90    # day of 3rd decrement (increment)
tdays3=3   # duration of 3rd decrement (increment)
wpr4=0.25 #0.26  # value of the 3rd decrement (increment)

tph6=245 #129 #270 - 25   # day of 4th decrement (increment)
tdays4=5   # duration of 4th decrement (increment)
wpr5=0.3 #0.26  # value of the 4th decrement (increment)

tph7=278 #288   # day of 5th decrement (increment)
tdays5=3   # duration of 5th decrement (increment)
wpr6=0.32 #0.35 #0.37  #0.35  # value of the 5th decrement (increment)

tph8=315 #320  #317   # day of 6th decrement (increment)
tdays6=7 #3 #5   # duration of 6th decrement (increment)
wpr7=0.04 #0.06 #0.1   # value of the 6th decrement (increment)

tph9=325 #330 #327   # day of 7th decrement (increment)
tdays7=14 #7   # duration of 7th decrement (increment)
wpr8=0.23 #0.2   # value of the 7th decrement (increment)

tph10=450 #475 #460 #465    # day of 8th decrement (increment)
tdays8=3 #3 #1   # duration of 8th decrement (increment)
wpr9=0.45 #0.5 #0.4 #0.5   # value of the 8th decrement (increment)

tph11=510    # day of 9th decrement (increment)
tdays9=3   # duration of 9th decrement (increment)
wpr10=0.15 #0.2 #0.22 #0.26 #0.5  # value of the 9th decrement (increment)

tph12=515    # day of 9th decrement (increment)
tdays10=1   # duration of 9th decrement (increment)
wpr11=0.09 #0.2 #0.22 #0.26 #0.5  # value of the 9th decrement (increment)
...
runs=/Users/supercarlangas/schamm/epidemiology/Random_SLIRD/manuscript/figures/fits/newfiguredatas/jal/
code=/Users/supercarlangas/schamm/epidemiology/Random_SLIRD/manuscript/figures/fits/newfiguredatas/jal/code
#========================================================================================================
#=========================================================================================================
if [ $cop == '4' ]; then
