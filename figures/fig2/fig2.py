...
fig.text(0.005, 0.55, r'$\mathrm{individuals}$', va='center', rotation='vertical',fontsize=(25))
...
ax1.bar(gm5io1[:,0], gm5io1[:,1],color = colormap2(normalize2(3)), width=0.9 )
...
ax3.bar(gm5io10[:,0], gm5io10[:,1],color = colormap2(normalize2(3)), width=0.9 )
...
ax2.bar(gm10io1[:,0], gm10io1[:,1],color = colormap2(normalize2(3)), width=0.9 )
...
ax4.bar(gm10io10[:,0], gm10io10[:,1],color = colormap2(normalize2(3)), width=0.9 )
...
ax5.plot(0,0,color = colormap(normalize(2)),label=r'$W(t)$', linewidth=2)
ax5.plot(0,0,color = colormap(normalize(4)),label=r'$C(t)$', linewidth=2)
ax5.plot(0,0,color = colormap(normalize(6)),label=r'$H(t)$', linewidth=2)
ax5.plot(g50io1[:,0],g50io1[:,1],color = colormap3(normalize3(1)),linestyle='--',label=r'$L(t)$', linewidth=2)
ax5.plot(g50io1[:,0],g50io1[:,3],color = colormap3(normalize3(2)),linestyle='--',label=r'$I(t)$', linewidth=2)
...
axw5=plt.axes([0.54,0.61,.25,.32])
axw5.axvspan(x0,x1,color='lightskyblue')
axw5.axvspan(x1,x7,color='lightcyan')
axw5.plot(g50io1w[:,0],g50io1w[:,1],color = colormap(normalize(2)),label=r'$W(t)$', linewidth=2)
axw5.plot(g50io1w[:,0],g50io1w[:,2],color = colormap(normalize(4)),label=r'$C(t)$', linewidth=2)
axw5.plot(g50io1w[:,0],g50io1w[:,3],color = colormap(normalize(6)),label=r'$H(t)$', linewidth=2)
