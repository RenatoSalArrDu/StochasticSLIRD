...
wcdmx=np.loadtxt('datas/cdmx/fort.15')
wjal=np.loadtxt('datas/jal/fort.15')
wnl=np.loadtxt('datas/nl/fort.15')

wcamp=np.loadtxt('datas/camp/fort.15')
wnay=np.loadtxt('datas/nay/fort.15')
woax=np.loadtxt('datas/oax/fort.15')

wchis=np.loadtxt('datas/chis/fort.15')
wedmx=np.loadtxt('datas/edmx/fort.15')
wmich=np.loadtxt('datas/mich/fort.15')
...
ax1.set_xlim(left = -0.05, right = 0.1)
...
ax1.axvline(x = cdmxpx[0], color=colormap(normalize(1)), linestyle="--",linewidth=1)
cdmxp2 = ax1.scatter(cdmxpx[1],cdmxpy[1], marker='o', color=colormap(normalize(2)))
ax1.axvline(x = cdmxpx[1], color=colormap(normalize(2)), linestyle="--",linewidth=1)
cdmxp3  = ax1.scatter(cdmxpx[2],cdmxpy[2], marker='o', color=colormap(normalize(3)))
ax1.axvline(x = cdmxpx[2], color=colormap(normalize(3)), linestyle="--",linewidth=1)
cdmxp4  = ax1.scatter(cdmxpx[3],cdmxpy[3], marker='o', color=colormap(normalize(4)))
ax1.axvline(x = cdmxpx[3], color=colormap(normalize(4)), linestyle="--",linewidth=1)
cdmxp5  = ax1.scatter(cdmxpx[4],cdmxpy[4], marker='o', color=colormap(normalize(5)))
ax1.axvline(x = cdmxpx[4], color=colormap(normalize(5)), linestyle="--",linewidth=1)
cdmxp6 = ax1.scatter(cdmxpx[5],cdmxpy[5], marker='o', color=colormap(normalize(6)))
ax1.axvline(x = cdmxpx[5], color=colormap(normalize(6)), linestyle="--",linewidth=1)
...
ax2.set_xlim(left = -0.05, right = 0.1)
...
ax2.axvline(x = jalpx[0], color=colormap(normalize(1)), linestyle="--",linewidth=1)
jalp2 = ax2.scatter(jalpx[1],jalpy[1], marker='o', color=colormap(normalize(2)))
ax2.axvline(x = jalpx[1], color=colormap(normalize(2)), linestyle="--",linewidth=1)
jalp3  = ax2.scatter(jalpx[2],jalpy[2], marker='o', color=colormap(normalize(3)))
ax2.axvline(x = jalpx[2], color=colormap(normalize(3)), linestyle="--",linewidth=1)
jalp4  = ax2.scatter(jalpx[3],jalpy[3], marker='o', color=colormap(normalize(4)))
ax2.axvline(x = jalpx[3], color=colormap(normalize(4)), linestyle="--",linewidth=1)
jalp5  = ax2.scatter(jalpx[4],jalpy[4], marker='o', color=colormap(normalize(5)))
ax2.axvline(x = jalpx[4], color=colormap(normalize(5)), linestyle="--",linewidth=1)
jalp6  = ax2.scatter(jalpx[5],jalpy[5], marker='o', color=colormap(normalize(6)))
ax2.axvline(x = jalpx[5], color=colormap(normalize(6)), linestyle="--",linewidth=1)
jalp7  = ax2.scatter(jalpx[6],jalpy[6], marker='o', color=colormap(normalize(7)))
ax2.axvline(x = jalpx[6], color=colormap(normalize(7)), linestyle="--",linewidth=1)
...
ax3.set_xlim(left = -0.05, right = 0.1)
...
ax3.axvline(x = nlpx[0], color=colormap(normalize(1)), linestyle="--",linewidth=1)
nlp2 = ax3.scatter(nlpx[1],nlpy[1], marker='o', color=colormap(normalize(2)))
ax3.axvline(x = nlpx[1], color=colormap(normalize(2)), linestyle="--",linewidth=1)
nlp3  = ax3.scatter(nlpx[2],nlpy[2], marker='o', color=colormap(normalize(3)))
ax3.axvline(x = nlpx[2], color=colormap(normalize(3)), linestyle="--",linewidth=1)
nlp4  = ax3.scatter(nlpx[3],nlpy[3], marker='o', color=colormap(normalize(4)))
ax3.axvline(x = nlpx[3], color=colormap(normalize(4)), linestyle="--",linewidth=1)
nlp5  = ax3.scatter(nlpx[4],nlpy[4], marker='o', color=colormap(normalize(5)))
ax3.axvline(x = nlpx[4], color=colormap(normalize(5)), linestyle="--",linewidth=1)
nlp6 = ax3.scatter(nlpx[5],nlpy[5], marker='o', color=colormap(normalize(6)))
ax3.axvline(x = nlpx[5], color=colormap(normalize(6)), linestyle="--",linewidth=1)
...
ax4.set_xlim(left = -0.05, right = 0.1)
...
ax4.axvline(x = edmxpx[0], color=colormap(normalize(1)), linestyle="--",linewidth=1)
edmxp2 = ax4.scatter(edmxpx[1],edmxpy[1], marker='o', color=colormap(normalize(2)))
ax4.axvline(x = edmxpx[1], color=colormap(normalize(2)), linestyle="--",linewidth=1)
edmxp3  = ax4.scatter(edmxpx[2],edmxpy[2], marker='o', color=colormap(normalize(3)))
ax4.axvline(x = edmxpx[2], color=colormap(normalize(3)), linestyle="--",linewidth=1)
edmxp4  = ax4.scatter(edmxpx[3],edmxpy[3], marker='o', color=colormap(normalize(4)))
ax4.axvline(x = edmxpx[3], color=colormap(normalize(4)), linestyle="--",linewidth=1)
edmxp5  = ax4.scatter(edmxpx[4],edmxpy[4], marker='o', color=colormap(normalize(5)))
ax4.axvline(x = edmxpx[4], color=colormap(normalize(5)), linestyle="--",linewidth=1)
edmxp6 = ax4.scatter(edmxpx[5],edmxpy[5], marker='o', color=colormap(normalize(6)))
ax4.axvline(x = edmxpx[5], color=colormap(normalize(6)), linestyle="--",linewidth=1)
...
ax5.set_xlim(left = -0.05, right = 0.1)
...
ax5.axvline(x = michpx[0], color=colormap(normalize(1)), linestyle="--",linewidth=1)
michp2 = ax5.scatter(michpx[1],michpy[1], marker='o', color=colormap(normalize(2)))
ax5.axvline(x = michpx[1], color=colormap(normalize(2)), linestyle="--",linewidth=1)
michp3  = ax5.scatter(michpx[2],michpy[2], marker='o', color=colormap(normalize(3)))
ax5.axvline(x = michpx[2], color=colormap(normalize(3)), linestyle="--",linewidth=1)
michp4  = ax5.scatter(michpx[3],michpy[3], marker='o', color=colormap(normalize(4)))
ax5.axvline(x = michpx[3], color=colormap(normalize(4)), linestyle="--",linewidth=1)
michp5  = ax5.scatter(michpx[4],michpy[4], marker='o', color=colormap(normalize(5)))
ax5.axvline(x = michpx[4], color=colormap(normalize(5)), linestyle="--",linewidth=1)
michp6 = ax5.scatter(michpx[5],michpy[5], marker='o', color=colormap(normalize(6)))
ax5.axvline(x = michpx[5], color=colormap(normalize(6)), linestyle="--",linewidth=1)
michp7 = ax5.scatter(michpx[6],michpy[6], marker='o', color=colormap(normalize(7)))
ax5.axvline(x = michpx[6], color=colormap(normalize(7)), linestyle="--",linewidth=1)
...
ax6.set_xlim(left = -0.05, right = 0.1)
...
ax6.axvline(x = chispx[0], color=colormap(normalize(1)), linestyle="--",linewidth=1)
chisp2 = ax6.scatter(chispx[1],chispy[1], marker='o', color=colormap(normalize(2)))
ax6.axvline(x = chispx[1], color=colormap(normalize(2)), linestyle="--",linewidth=1)
chisp3  = ax6.scatter(chispx[2],chispy[2], marker='o', color=colormap(normalize(3)))
ax6.axvline(x = chispx[2], color=colormap(normalize(3)), linestyle="--",linewidth=1)
chisp4  = ax6.scatter(chispx[3],chispy[3], marker='o', color=colormap(normalize(4)))
ax6.axvline(x = chispx[3], color=colormap(normalize(4)), linestyle="--",linewidth=1)
chisp5  = ax6.scatter(chispx[4],chispy[4], marker='o', color=colormap(normalize(5)))
ax6.axvline(x = chispx[4], color=colormap(normalize(5)), linestyle="--",linewidth=1)
chisp6 = ax6.scatter(chispx[5],chispy[5], marker='o', color=colormap(normalize(6)))
ax6.axvline(x = chispx[5], color=colormap(normalize(6)), linestyle="--",linewidth=1)
...
ax7.set_xlim(left = -0.05, right = 0.1)
...
ax7.axvline(x = camppx[0], color=colormap(normalize(1)), linestyle="--",linewidth=1)
campp2 = ax7.scatter(camppx[1],camppy[1], marker='o', color=colormap(normalize(2)))
ax7.axvline(x = camppx[1], color=colormap(normalize(2)), linestyle="--",linewidth=1)
campp3  = ax7.scatter(camppx[2],camppy[2], marker='o', color=colormap(normalize(3)))
ax7.axvline(x = camppx[2], color=colormap(normalize(3)), linestyle="--",linewidth=1)
campp4  = ax7.scatter(camppx[3],camppy[3], marker='o', color=colormap(normalize(4)))
ax7.axvline(x = camppx[3], color=colormap(normalize(4)), linestyle="--",linewidth=1)
campp5  = ax7.scatter(camppx[4],camppy[4], marker='o', color=colormap(normalize(5)))
ax7.axvline(x = camppx[4], color=colormap(normalize(5)), linestyle="--",linewidth=1)
...
ax8.set_xlim(left = -0.05, right = 0.1)
...
ax8.axvline(x = naypx[0], color=colormap(normalize(1)), linestyle="--",linewidth=1)
nayp2 = ax8.scatter(naypx[1],naypy[1], marker='o', color=colormap(normalize(2)))
ax8.axvline(x = naypx[1], color=colormap(normalize(2)), linestyle="--",linewidth=1)
nayp3  = ax8.scatter(naypx[2],naypy[2], marker='o', color=colormap(normalize(3)))
ax8.axvline(x = naypx[2], color=colormap(normalize(3)), linestyle="--",linewidth=1)
nayp4  = ax8.scatter(naypx[3],naypy[3], marker='o', color=colormap(normalize(4)))
ax8.axvline(x = naypx[3], color=colormap(normalize(4)), linestyle="--",linewidth=1)
nayp5  = ax8.scatter(naypx[4],naypy[4], marker='o', color=colormap(normalize(5)))
ax8.axvline(x = naypx[4], color=colormap(normalize(5)), linestyle="--",linewidth=1)
...
#sax9.set_ylim(top = 3, bottom = 0)
ax9.set_xlim(left = -0.05, right = 0.1)
...
ax9.axvline(x = oaxpx[0], color=colormap(normalize(1)), linestyle="--",linewidth=1)
oaxp2 = ax9.scatter(oaxpx[1],oaxpy[1], marker='o', color=colormap(normalize(2)))
ax9.axvline(x = oaxpx[1], color=colormap(normalize(2)), linestyle="--",linewidth=1)
oaxp3  = ax9.scatter(oaxpx[2],oaxpy[2], marker='o', color=colormap(normalize(3)))
ax9.axvline(x = oaxpx[2], color=colormap(normalize(3)), linestyle="--",linewidth=1)
oaxp4  = ax9.scatter(oaxpx[3],oaxpy[3], marker='o', color=colormap(normalize(4)))
ax9.axvline(x = oaxpx[3], color=colormap(normalize(4)), linestyle="--",linewidth=1)
oaxp5  = ax9.scatter(oaxpx[4],oaxpy[4], marker='o', color=colormap(normalize(5)))
ax9.axvline(x = oaxpx[4], color=colormap(normalize(5)), linestyle="--",linewidth=1)
oaxp6 = ax9.scatter(oaxpx[5],oaxpy[5], marker='o', color=colormap(normalize(6)))
ax9.axvline(x = oaxpx[5], color=colormap(normalize(6)), linestyle="--",linewidth=1)
