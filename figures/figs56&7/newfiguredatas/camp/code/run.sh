...
ni=14 #3 #7      # initial infected
ns=9999986 #3   # initial susceptible
...
tdays=15    # duration of 1st decrement (increment)
wpr2=0.25 # value of the 1st decrement (increment)

tph4=48    # day of 2nd decrement (increment)
tdays2=3   # duration of 2nd decrement (increment)
wpr3=0.59 #0.6 #0.63 #0.6  # value of the 2nd decrement (increment)

tph5=63 #65    # day of 3rd decrement (increment)
tdays3=5   # duration of 3rd decrement (increment)
wpr4=0.3  # value of the 3rd decrement (increment)

tph6=104 #104    # day of 4th decrement (increment)
tdays4=5   # duration of 4th decrement (increment)
wpr5=0.15 #0.27  # value of the 4th decrement (increment)

tph7=167   # day of 5th decrement (increment)
tdays5=3   # duration of 5th decrement (increment)
wpr6=0.2 #0.42  #0.35  # value of the 5th decrement (increment)

tph8=270    # day of 6th decrement (increment)
tdays6=3  # duration of 6th decrement (increment)
wpr7=0.28   # value of the 6th decrement (increment)

tph9=290   # day of 7th decrement (increment)
tdays7=3   # duration of 7th decrement (increment)
wpr8=0.28 #0.17   # value of the 7th decrement (increment)

tph10=300    # day of 8th decrement (increment)
tdays8=40   # duration of 8th decrement (increment)
wpr9=0.28 #0.43 #0.4   # value of the 8th decrement (increment)

tph11=0 #470    # day of 9th decrement (increment)
tdays9=0   # duration of 9th decrement (increment)
wpr10=0 #0.2 #0.23 #0.22  # value of the 9th decrement (increment)

tph12=0 #515 #470    # day of 9th decrement (increment)
tdays10=0 #1   # duration of 9th decrement (increment)
wpr11=0 #0.15 #0.22  # value of the 9th decrement (increment)
...
runs=/Users/supercarlangas/schamm/epidemiology/Random_SLIRD/manuscript/figures/fits/newfiguredatas/camp/
code=/Users/supercarlangas/schamm/epidemiology/Random_SLIRD/manuscript/figures/fits/newfiguredatas/camp/code
#========================================================================================================
#=========================================================================================================
if [ $cop == '4' ]; then
...
plt.plot(dat4[:,0]+$tshf,dat4[:,4],color = colormap(normalize(1)),marker='$mark',
