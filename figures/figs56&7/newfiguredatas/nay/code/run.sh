ni=13 #3 #7      # initial infected
ns=9999987 #3   # initial susceptible
...
ro=4      # basic rep. num.
leth=0.1   # fatality
traj=5000 #5000   #number of trajectories
...
tph3=10 #10 # day of 1st decrement (increment)
tdays=3 #7    # duration of 1st decrement (increment)
wpr2=0.37 #0.38 # value of the 1st decrement (increment)

tph4=60 #73    # day of 2nd decrement (increment)
tdays2=14 #7   # duration of 2nd decrement (increment)
wpr3=0.28 #0.25 #0.35 #0.57 #0.55  # value of the 2nd decrement (increment)

tph5=100    # day of 3rd decrement (increment)
tdays3=5   # duration of 3rd decrement (increment)
wpr4=0.28 #0.3  # value of the 3rd decrement (increment)

tph6=115  # day of 4th decrement (increment)
tdays4=3   # duration of 4th decrement (increment)
wpr5=0.23 #0.27  # value of the 4th decrement (increment)

tph7=150 #169 #110   # day of 5th decrement (increment)
tdays5=3   # duration of 5th decrement (increment)
wpr6=0.28 #0.42  #0.35  # value of the 5th decrement (increment)

tph8=200 #190    # day of 6th decrement (increment)
tdays6=5  # duration of 6th decrement (increment)
wpr7=0.25   # value of the 6th decrement (increment)

tph9=280    # day of 7th decrement (increment)
tdays7=3   # duration of 7th decrement (increment)
wpr8=0.4 #0.17   # value of the 7th decrement (increment)
...
runs=/Users/supercarlangas/schamm/epidemiology/Random_SLIRD/manuscript/figures/fits/newfiguredatas/nay/
code=/Users/supercarlangas/schamm/epidemiology/Random_SLIRD/manuscript/figures/fits/newfiguredatas/nay/code
#========================================================================================================
#=========================================================================================================
if [ $cop == '4' ]; then
